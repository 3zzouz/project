          ...
          <div class="col-12 col-md-9 col-lg-7 col-xl-6">
            <div class="card" style="border-radius: 15px">
              <div class="card-body px-5 py-3">
                ...
                <form class="needs-validation" action="signup.php" method="post" id="signup-form" novalidate>
                  ...
                  <div class="col mb-3 form-floating">
                    <input type="password" class="form-control" id="validationCustom03" placeholder="blablalba"
                      name="password" required />
                    <label for="validationCustom03">Password</label>
                  </div>
                  <div class="col mb-3 form-floating">
                    <input type="password" name="password2" class="form-control" id="validationCustom05" required
                      placeholder="blablalba" />
                  ...
                  <p class="text-center" style="margin-top: 1rem; margin-bottom: -5px">
                    ...
                    <a style="text-decoration: none; color: orangered" href="../login/user/index.php">Sign In</a>
                  </p>
                </form>
              </div>
            </div>
